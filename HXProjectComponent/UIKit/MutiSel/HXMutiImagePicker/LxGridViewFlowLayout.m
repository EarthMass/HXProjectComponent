...
- (void)setCanMoveEnable:(BOOL)canMoveEnable
{
    _panGestureRecognizer.enabled = canMoveEnable;
    _longPressGestureRecognizer.enabled = canMoveEnable;
}
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            HXMutiSelectCell *sourceCell = (HXMutiSelectCell *)sourceCollectionViewCell;
